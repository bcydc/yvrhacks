  ...
  return (
    <div className="flex w-full flex-col items-center gap-6 px-6 py-10 md:w-[1200px] md:px-0 md:pt-20">
      <div className="flex flex-col items-center gap-4 md:items-start md:gap-0">
        <h1 className="font-cloudy title-shadow text-5xl font-bold text-white md:text-[11rem] md:leading-normal">
          yvrHacks
        </h1>
        <div className="flex flex-col gap-2 md:-mt-8 md:pl-32">
          <p className="text-center text-base font-semibold text-white md:text-left md:text-3xl">
            Sunday, Sep 29 | BC&apos;s Biggest High School Hackathon
          </p>
          <p className="text-center text-base font-medium text-white text-opacity-80 md:text-left md:text-3xl">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <a
          ...
          className="flex items-center gap-3 rounded bg-sky-700 px-4 py-2 transition duration-300 hover:bg-sky-800 md:px-12 md:py-5"
        >
